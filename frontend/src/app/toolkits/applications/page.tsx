    ...
    <main>
      <div className="mx-auto max-w-6xl">
        ...
        <section className="grid gap-6 sm:grid-cols-2 xl:grid-cols-3">
          {links.map((l) => (
            <a key={l.label} href={l.href} className={`group relative rounded-2xl p-[1.5px] ${l.disabled ? 'opacity-60 cursor-not-allowed' : 'bg-gradient-to-br from-amber-500/40 to-pink-500/40 hover:from-amber-500 hover:to-pink-500 hover:scale-[1.01] transition-all duration-300'}`}>
