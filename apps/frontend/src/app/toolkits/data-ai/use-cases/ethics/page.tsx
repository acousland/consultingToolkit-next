    ...
    <main>
      <div className="mx-auto max-w-3xl space-y-4">
        ...
        <form onSubmit={onSubmit} className="space-y-3">
          ...
          <button disabled={loading || !text.trim()} className="px-4 py-2 rounded-md bg-gradient-to-br from-indigo-600 to-violet-600 text-white disabled:opacity-50">{loading?"Reviewing...":"Review"}</button>
        </form>
        ...
        {res && (
          <div className="grid sm:grid-cols-2 gap-3">
            ...
            <div className="sm:col-span-2 rounded-2xl border border-white/10 bg-black/40">
