    ...
    onClick={(e)=>{ if (e.target === e.currentTarget) { inputRef.current?.click(); } }}
      ...
      {preview.length > 0 && (
        <div className="mt-4 space-y-2">
          {/* Preview table with sticky detected headers */}
          <div>
            ...
            <div className="overflow-auto border border-white/10 rounded-xl max-h-96">
              {/* Sticky detected headers inside the scroll area */}
              <div className="sticky top-0 z-10 bg-zinc-950/70 backdrop-blur px-3 py-2 border-b border-white/10">
